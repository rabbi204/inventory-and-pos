                    ...
                    <div class="card-body">
                        <div class="row align-items-center">
                            <div class="col mr-2">
                                ...
                                <div class="h5 mb-0 font-weight-bold text-gray-800">{{ todaysell }} tk</div>
                    ...
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                ...
                                <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">{{ due }} tk</div>
                                <div class="mt-2 mb-0 text-muted text-xs">
                    ...
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                ...
                                <div class="h5 mb-0 font-weight-bold text-gray-800">{{ expense }} tk</div>
                                <div class="mt-2 mb-0 text-muted text-xs">
