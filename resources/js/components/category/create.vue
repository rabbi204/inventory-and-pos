    ...
    <div>
        <div class="row justify-content-center">
            <div class="col-xl-8 col-lg-8 col-md-8">
                <router-link to="/category" class="btn btn-primary btn-sm">All Categories</router-link>
                                ...
                                <div class="login-form">
                                    ...
                                    <form class="user" @submit.prevent="categoryInsert">
                                        ...
                                        <div class="form-group">
                                            <div class="form-row">
                                                <div class="col-md-12">
                                                     <input type="text" class="form-control" v-model="form.category_name"  placeholder="Enter Category Name" required />
